            ...
            <div class="messages-container">
                ...
                <div class="message-view">
                    <div class="message-header">
                        <h2 id="message-username">Select a conversation</h2>
                    ...
                    <div class="message-input">
                        <textarea id="message-textarea" placeholder="Type a message..."></textarea>
                        <button class="btn primary-btn" id="send-message-btn">Send</button>
                    </div>
                </div>
            </div>
        </div>
